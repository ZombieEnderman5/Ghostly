 ...
 */
public class ModelMutatedSheepWool extends ModelBase {
    ...
    public ModelMutatedSheepWool() {
        this.textureWidth = 64;
        this.textureHeight = 32;
        this.body = new ModelRenderer(this, 28, 8);
        this.body.setRotationPoint(0.0F, 4.0F, 2.0F);
        this.body.addBox(-4.0F, -8.0F, -3.0F, 8, 16, 6, 1.75F);
        this.leftLeg = new ModelRenderer(this, 0, 16);
        this.leftLeg.mirror = true;
        this.leftLeg.setRotationPoint(2.0F, 12.0F, 2.0F);
        this.leftLeg.addBox(-2.0F, 0.0F, -2.0F, 4, 6, 4, 0.5F);
        this.head = new ModelRenderer(this, 0, 0);
        this.head.setRotationPoint(0.0F, -5.0F, 1.5F);
        this.head.addBox(-3.0F, -4.0F, -6.0F, 6, 6, 6, 0.6F);
        this.leftArm = new ModelRenderer(this, 0, 16);
        this.leftArm.mirror = true;
        this.leftArm.setRotationPoint(7.7F, -2.0F, 2.0F);
        this.leftArm.addBox(-2.0F, 0.0F, -2.0F, 4, 6, 4, 0.5F);
        this.setRotateAngle(leftArm, 0.0F, 0.0F, -0.10000736613927509F);
        this.rightLeg = new ModelRenderer(this, 0, 16);
        this.rightLeg.setRotationPoint(-2.0F, 12.0F, 2.0F);
        this.rightLeg.addBox(-2.0F, 0.0F, -2.0F, 4, 6, 4, 0.5F);
        this.rightArm = new ModelRenderer(this, 0, 16);
        this.rightArm.setRotationPoint(-7.7F, -2.0F, 2.0F);
        this.rightArm.addBox(-2.0F, 0.0F, -2.0F, 4, 6, 4, 0.5F);
