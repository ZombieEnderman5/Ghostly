...
public class LayerPossessedStrayEyes implements LayerRenderer<EntityPossessedStray> {
	...
	public LayerPossessedStrayEyes(RenderPossessedStray stoneGolemRendererIn) {
	...
	public void doRenderLayer(EntityPossessedStray entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
		...
		if (entitylivingbaseIn.getEyeType() == 0) {
			...
			stoneGolemRenderer.bindTexture(RES_WHITE_POSSESSED_STRAY_EYES);
			
		} else if (entitylivingbaseIn.getEyeType() == 1) {
			
			stoneGolemRenderer.bindTexture(RES_BLUE_POSSESSED_STRAY_EYES);
			
		} else if (entitylivingbaseIn.getEyeType() == 2) {
			
			stoneGolemRenderer.bindTexture(RES_GREEN_POSSESSED_STRAY_EYES);
			
		} else if (entitylivingbaseIn.getEyeType() == 3) {
			
			stoneGolemRenderer.bindTexture(RES_RED_POSSESSED_STRAY_EYES);
			
		} else if (GhostlyConfig.AESTHETICS.multicolorPossessedStrayEyes) {
			
			if (entitylivingbaseIn.getEyeType() == 4) {
				
				stoneGolemRenderer.bindTexture(RES_BLUE_RED_LEFT_POSSESSED_STRAY_EYES);
				
			} else if (entitylivingbaseIn.getEyeType() == 5) {
				
				stoneGolemRenderer.bindTexture(RES_BLUE_RED_RIGHT_POSSESSED_STRAY_EYES);
				
			} else if (entitylivingbaseIn.getEyeType() == 6) {
				
				stoneGolemRenderer.bindTexture(RES_BLUE_WHITE_LEFT_POSSESSED_STRAY_EYES);
				
			} else if (entitylivingbaseIn.getEyeType() == 7) {
				
				stoneGolemRenderer.bindTexture(RES_BLUE_WHITE_RIGHT_POSSESSED_STRAY_EYES);
				
			} else if (entitylivingbaseIn.getEyeType() == 8) {
				
				stoneGolemRenderer.bindTexture(RES_GREEN_BLUE_LEFT_POSSESSED_STRAY_EYES);
				
			} else if (entitylivingbaseIn.getEyeType() == 9) {
				
				stoneGolemRenderer.bindTexture(RES_GREEN_BLUE_RIGHT_POSSESSED_STRAY_EYES);
				
			} else if (entitylivingbaseIn.getEyeType() == 10) {
				
				stoneGolemRenderer.bindTexture(RES_GREEN_RED_LEFT_POSSESSED_STRAY_EYES);
				
			} else if (entitylivingbaseIn.getEyeType() == 11) {
				
				stoneGolemRenderer.bindTexture(RES_GREEN_RED_RIGHT_POSSESSED_STRAY_EYES);
				
			} else if (entitylivingbaseIn.getEyeType() == 12) {
				
				stoneGolemRenderer.bindTexture(RES_GREEN_WHITE_LEFT_POSSESSED_STRAY_EYES);
				
			} else if (entitylivingbaseIn.getEyeType() == 13) {
				
				stoneGolemRenderer.bindTexture(RES_GREEN_WHITE_RIGHT_POSSESSED_STRAY_EYES);
