...
public class EntityTippedCorporealityArrow extends EntityCorporealityArrow {
    ...
    public EntityTippedCorporealityArrow(World worldIn) {
		
		super(worldIn);
		
	}
    
	public EntityTippedCorporealityArrow(World worldIn, EntityLivingBase shooter) {
		
		super(worldIn, shooter);
		
	}
	
	public EntityTippedCorporealityArrow(World worldIn, double x, double y, double z) {
