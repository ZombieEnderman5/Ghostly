...
public class EntityAIRestrictLight extends EntityAIBase {
    ...
    {
        return GhostlyConfig.MOBS.shadeDissipationLightLevel != -0.1D && this.world.getLightBrightness(new BlockPos(entity)) > ((float)GhostlyConfig.MOBS.shadeDissipationLightLevel * 0.6);
    }
